...
import '/venda/deletar_carrinho_produto/deletar_carrinho_produto_widget.dart';
...
import 'carrinho_p_c_model.dart';
export 'carrinho_p_c_model.dart';

class CarrinhoPCWidget extends StatefulWidget {
  const CarrinhoPCWidget({super.key});

  static String routeName = 'CarrinhoPC';
  static String routePath = '/carrinhoPC';

  @override
  State<CarrinhoPCWidget> createState() => _CarrinhoPCWidgetState();
}

class _CarrinhoPCWidgetState extends State<CarrinhoPCWidget> {
  late CarrinhoPCModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CarrinhoPCModel());
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: StreamBuilder<List<CarrinhoRecord>>(
          ...
          builder: (context, snapshot) {
            ...
            List<CarrinhoRecord> containerCarrinhoRecordList = snapshot.data!;
                      ...
                      child: Row(
                        ...
                        children: [
                          Column(
                            mainAxisSize: MainAxisSize.max,
                            children: [
                              if ((containerCarrinhoRecordList.isNotEmpty) ==
                                  false)
                                Container(
                                  width: 800.0,
                                  decoration: BoxDecoration(),
                                                ...
                                                itemBuilder:
                                                  ...
                                                  return Column(
                                                    ...
                                                    children: [
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              if (functions.carrinhoSelecionadoVisto(containerCarrinhoRecordList.toList()) == false)
                                                                                Container(
                                                                                  width: double.infinity,
                                                                              ...
                                                                              if (functions.carrinhoSelecionadoVisto(containerCarrinhoRecordList.toList()) ?? true)
                                                                                Container(
                                                                                  width: double.infinity,
                                                                                  height: double.infinity,
                                                                                  clipBehavior: Clip.antiAlias,
                                                              ...
                                                              child: Container(
                                                                ...
                                                                decoration:
                                                                  ...
                                                                  borderRadius:
                                                                    ...
                                                                    bottomLeft:
                                                                      ...
                                                                      functions.carrinhoIndexUltimo(carinhoIndex, containerCarrinhoRecordList.toList()) ==
                                                                              true
                                                                          ? 8.0
                                                                          : 0.0,
                                                                      0.0,
                                                                ...
                                                                child: Column(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    if (functions.carrinhoLoja(
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child: StreamBuilder<
                                                                            LojasRecord>(
                                                                          stream:
                                                                              LojasRecord.getDocument(carinhoCarrinhoRecord.lojaRef!),
                                                                          builder:
                                                                              (context, snapshot) {
                                                                            // Customize what your widget looks like when it's loading.
                                                                            if (!snapshot.hasData) {
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              onTap: () async {
                                                                                if (carinhoCarrinhoRecord.selecionado == true) {
                                                                                  await carinhoCarrinhoRecord.reference.update(createCarrinhoRecordData(
                                                                                    selecionado: false,
                                                                                  ));
                                                                                } else {
                                                                                  await carinhoCarrinhoRecord.reference.update(createCarrinhoRecordData(
                                                                    ...
                                                                    if ((functions.carrinhoLoja2(containerCarrinhoRecordList.toList(), carinhoCarrinhoRecord.reference) ==
                                                                            true) &&
                                                                        (functions.carrinhoIndexUltimo(carinhoIndex,
                                                                                containerCarrinhoRecordList.toList()) !=
                                                                            true))
                                                                      Container(
                                                                        width: double
                                                                    ...
                                                                    if ((functions.carrinhoLoja(containerCarrinhoRecordList.toList(), carinhoCarrinhoRecord.reference) == true) &&
                                                                        (functions.carrinhoLoja2(containerCarrinhoRecordList.toList(), carinhoCarrinhoRecord.reference) ==
                                                                            false) &&
                                                                        (functions.carrinhoLoja3(containerCarrinhoRecordList.toList(),
                                                                                carinhoCarrinhoRecord.reference) ==
                                                                            false))
                                                                      Container(
                                                                        width: double
                                                      ...
                                                      if (carinhoCarrinhoRecord
                                                        ...
                                                        StreamBuilder<
                                                          ...
                                                          builder: (context,
                                                            ...
                                                            final editVarianteVarianteRecord =
                                                                snapshot.data!;
                                                                ...
                                                                builder: (context,
                                                                  ...
                                                                  return Container(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      key: Key(
                                                                          'Key08m_${carinhoIndex}_of_${carinhoCarrinhoRecordList.length}'),
                                                                      exiteVariante: editVarianteVarianteRecord.opcaoTitulo1 !=
                                                                              '',
                                                                      preco: containerProdutoRecord
                                                                          .preco,
                                                                      produtoRef:
                                                                          carinhoCarrinhoRecord
                                                                              .itens!,
                                                            ...
                                                            builder: (context,
                                                              ...
                                                              return Container(
                                                                ...
                                                                child:
                                                                    AtualizarCarrinhoProdutoWidget(
                                                                  key: Key(
                                                                      'Keybye_${carinhoIndex}_of_${carinhoCarrinhoRecordList.length}'),
                                                      ...
                                                      DeletarCarrinhoProdutoWidget(
                                                        key: Key(
                                                            'Keyk96_${carinhoIndex}_of_${carinhoCarrinhoRecordList.length}'),
                                                        produtoRef:
                                                            carinhoCarrinhoRecord
                                                                .itens!,
                                                        carrinhoRef:
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      if ((functions.carrinhoLoja(containerCarrinhoRecordList.toList(), carinhoCarrinhoRecord.reference) == true) &&
                                                                          (functions.carrinhoLoja2(containerCarrinhoRecordList.toList(), carinhoCarrinhoRecord.reference) ==
                                                                              false) &&
                                                                          (functions.carrinhoLoja3(containerCarrinhoRecordList.toList(), carinhoCarrinhoRecord.reference) ==
                                                                              false))
                                                                        Container(
                                                                          width:
                                                                              double.infinity,
                                                            ...
                                                            InkWell(
                                                              ...
                                                              onTap: () async {
                                                                FFAppState().CarrinhoTemporarioInternacional = functions
                                                                    .carrinhoAfiliadTodosLista(FFAppState()
                                                                        .CarrinhoTemporarioInternacional
                                                                        .toList())
                                                                    .toList()
                                                                    .cast<
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                            ...
                                                                            FFAppState().CarrinhoTemporarioInternacional =
                                                                                functions.carrinhoAfiliadoSelecionado(FFAppState().CarrinhoTemporarioInternacional.toList(), listaStringItem).toList().cast<String>();
                                                                            safeSetState(() {});
                                                                          },
                                                                          child:
                                                                              Container(
                                                                      ...
                                                                      Flexible(
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            if (functions.carrinhoTemporarioVarianteExiste(listaStringItem))
                                                                              Align(
                                                                                alignment: AlignmentDirectional(-1.0, 0.0),
                                                                                child: Padding(
                                                                                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 7.0, 0.0, 0.0),
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(
                                                          functions.calcularTotalDeQueriesTrue(
                                                              containerCarrinhoRecordList
                                                                  .toList()),
                                                          style: FlutterFlowTheme
                                                                  .of(context)
