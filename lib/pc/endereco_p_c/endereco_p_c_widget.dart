...
import 'endereco_p_c_model.dart';
export 'endereco_p_c_model.dart';

class EnderecoPCWidget extends StatefulWidget {
  const EnderecoPCWidget({
    super.key,
  ...
  @override
  State<EnderecoPCWidget> createState() => _EnderecoPCWidgetState();
}

class _EnderecoPCWidgetState extends State<EnderecoPCWidget> {
  late EnderecoPCModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EnderecoPCModel());
    ...
    _model.textField111TextController ??= TextEditingController();
    _model.textField111FocusNode ??= FocusNode();
    ...
    _model.textField777TextController ??= TextEditingController();
    _model.textField777FocusNode ??= FocusNode();

    _model.textController10 ??= TextEditingController();
    _model.textFieldFocusNode6 ??= FocusNode();

    _model.cpffTextController ??= TextEditingController();
    _model.cpffFocusNode ??= FocusNode();

    _model.cpffMask = MaskTextInputFormatter(mask: '###.###.###-##');
  ...
  Widget build(BuildContext context) {
    ...
    return Align(
      ...
      child: Container(
        ...
        child: Stack(
          children: [
            if ((FFAppState().pcEnderecoStatus == 'editar') &&
                (FFAppState().pcEnderecoRef != null))
              Column(
                    ...
                    child: Container(
                      ...
                      child: StreamBuilder<EnderecosRecord>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          final stackEnderecosRecord = snapshot.data!;
                                                                    ...
                                                                    child: Text(
                                                                      ...
                                                                      style: FlutterFlowTheme.of(
                                                                          ...
                                                                          .override(
                                                                            ...
                                                                            color: FFAppState().enderecoCer == 'trabalho'
                                                                    ...
                                                                    child: Text(
                                                                      ...
                                                                      style: FlutterFlowTheme.of(
                                                                          ...
                                                                          .override(
                                                                            ...
                                                                            color: FFAppState().enderecoCer == 'casa'
                                                                                ? FlutterFlowTheme.of(context).primary
                                                                                : Color(0xFF494A4B),
                                                                            fontSize:
                                                                                15.0,
            ...
            if (FFAppState().pcEnderecoStatus == '')
              Container(
                width: double.infinity,
                decoration: BoxDecoration(),
                child: Stack(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                15.0, 0.0, 15.0, 0.0),
                            child: StreamBuilder<List<EnderecosRecord>>(
                            ...
                            child: Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  FFAppState().estado = '';
                                  FFAppState().rua = '';
                                  FFAppState().pcEnderecoStatus = 'cadastrar';
                                  safeSetState(() {});
                                },
                                child: Container(
                                  height: 39.82,
            ...
            if (FFAppState().pcEnderecoStatus == 'cadastrar')
              Column(
                mainAxisSize: MainAxisSize.max,
                children: [
                  Expanded(
                              ...
                              child: Column(
                                ...
                                children: [
                                            ...
                                            Expanded(
                                              child: Align(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: TextFormField(
                                                    controller: _model
                                                        .textField111TextController,
                                                    focusNode: _model
                                                        .textField111FocusNode,
                                                    autofocus: false,
                                                    obscureText: false,
                                                    ...
                                                    cursorColor:
                                                        FlutterFlowTheme.of(
                                                            ...
                                                            .primaryText,
                                                    validator: _model
                                                        .textField111TextControllerValidator
                                                        .asValidator(context),
                                                  ),
                                                ),
                                              ),
                                  ...
                                  InkWell(
                                    ...
                                    highlightColor: Colors.transparent,
                                    onTap: () async {
                                      if (!(_model.ceppTextController.text !=
                                              '')) {
                                        ScaffoldMessenger.of(context)
                                            .showSnackBar(
                                          SnackBar(
                                                  ...
                                                  Expanded(
                                                    child: Align(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: TextFormField(
                                                          controller: _model
                                                              .textField777TextController,
                                                          focusNode: _model
                                                              .textField777FocusNode,
                                                          autofocus: false,
                                                          obscureText: false,
                                                          decoration:
                                                              InputDecoration(
                                                          ...
                                                          cursorColor:
                                                              FlutterFlowTheme.of(
                                                                  ...
                                                                  .primaryText,
                                                          validator: _model
                                                              .textField777TextControllerValidator
                                                              .asValidator(
                                                                  context),
                                                        ),
                                                      ),
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            var _shouldSetState = false;
                                            if (_model.textField111TextController
                                                        .text !=
                                                    '') {
                                              if (_model.textController2.text !=
                                                ...
                                                if (_model.ceppTextController
                                                            .text !=
                                                        '') {
                                                  if (_model.textField777TextController
                                                              .text !=
                                                          '') {
