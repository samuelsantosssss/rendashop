...
import 'rastreador_pedido_p_c_model.dart';
export 'rastreador_pedido_p_c_model.dart';

class RastreadorPedidoPCWidget extends StatefulWidget {
  const RastreadorPedidoPCWidget({
    super.key,
  ...
  static String routeName = 'Rastreador_PedidoPC';
  static String routePath = '/rastreadorPedidoPC';

  @override
  State<RastreadorPedidoPCWidget> createState() =>
      _RastreadorPedidoPCWidgetState();
}

class _RastreadorPedidoPCWidgetState extends State<RastreadorPedidoPCWidget> {
  late RastreadorPedidoPCModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RastreadorPedidoPCModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<PedidosTotalRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final rastreadorPedidoPCPedidosTotalRecord = snapshot.data!;
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: StreamBuilder<List<Rastreio2Record>>(
                          stream: queryRastreio2Record(
                            queryBuilder: (rastreio2Record) =>
                                rastreio2Record.where(
                              'pedidoRef2',
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<Rastreio2Record> containerRastreio2RecordList =
                                snapshot.data!;
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: Column(
                                        mainAxisSize: MainAxisSize.max,
                                        children: [
                                          if (rastreadorPedidoPCPedidosTotalRecord
                                                  .status ==
                                              'finalizado')
                                            Align(
                                              alignment: AlignmentDirectional(
                                              ...
                                              child: Padding(
                                                ...
                                                child: Text(
                                                  'Entregue em ${dateTimeFormat(
                                                    "yMMMd",
                                                    rastreadorPedidoPCPedidosTotalRecord
                                                        .dataEntregue,
                                                      ...
                                                      padding:
                                                          EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  0.0),
                                                      child: Text(
                                                        functions.estimativaFreteNascionalPosVenda(
                                                            rastreadorPedidoPCPedidosTotalRecord
                                                                .dataPedido!),
                                                        style:
                                                            FlutterFlowTheme.of(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                Icon(
                                                  Icons.circle_sharp,
                                                  color:
                                                      rastreadorPedidoPCPedidosTotalRecord.status ==
                                                              'finalizado'
                                                          ? FlutterFlowTheme.of(
                                                                  context)
                                                              .secondary
                                                    ...
                                                    InkWell(
                                                      ...
                                                      onTap: () async {
                                                        await Clipboard.setData(
                                                            ClipboardData(
                                                                text: rastreadorPedidoPCPedidosTotalRecord
                                                                    .codigoRastreio));
                                                      },
                                                      child: Row(
                                                        mainAxisSize:
