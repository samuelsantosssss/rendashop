...
import 'cadastrar_produto_p_c_widget.dart' show CadastrarProdutoPCWidget;
import 'package:flutter/material.dart';

class CadastrarProdutoPCModel
    extends FlutterFlowModel<CadastrarProdutoPCWidget> {
  ...
  bool? checkbox2Value;
  bool isDataUploading_uploadData33f44559 = false;
  FFUploadedFile uploadedLocalFile_uploadData33f44559 =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadData33f44559 = '';
  ...
  // State field(s) for variacao_1 widget.
  FocusNode? variacao1FocusNode;
  TextEditingController? variacao1TextController;
  String? Function(BuildContext, String?)? variacao1TextControllerValidator;
  // State field(s) for opcao1_1 widget.
  FocusNode? opcao11FocusNode;
  TextEditingController? opcao11TextController;
  String? Function(BuildContext, String?)? opcao11TextControllerValidator;
  // State field(s) for opcao1_2 widget.
  FocusNode? opcao12FocusNode;
  TextEditingController? opcao12TextController;
  String? Function(BuildContext, String?)? opcao12TextControllerValidator;
  // State field(s) for opcao1_3 widget.
  FocusNode? opcao13FocusNode;
  TextEditingController? opcao13TextController;
  String? Function(BuildContext, String?)? opcao13TextControllerValidator;
  // State field(s) for opcao1_4 widget.
  FocusNode? opcao14FocusNode;
  TextEditingController? opcao14TextController;
  String? Function(BuildContext, String?)? opcao14TextControllerValidator;
  // State field(s) for opcao1_5 widget.
  FocusNode? opcao15FocusNode;
  TextEditingController? opcao15TextController;
  String? Function(BuildContext, String?)? opcao15TextControllerValidator;
  // State field(s) for opcao1_6 widget.
  FocusNode? opcao16FocusNode;
  TextEditingController? opcao16TextController;
  String? Function(BuildContext, String?)? opcao16TextControllerValidator;
  // State field(s) for opcao1_7 widget.
  FocusNode? opcao17FocusNode;
  TextEditingController? opcao17TextController;
  String? Function(BuildContext, String?)? opcao17TextControllerValidator;
  // State field(s) for opcao1_8 widget.
  FocusNode? opcao18FocusNode;
  TextEditingController? opcao18TextController;
  String? Function(BuildContext, String?)? opcao18TextControllerValidator;
  // State field(s) for opcao1_9 widget.
  FocusNode? opcao19FocusNode;
  TextEditingController? opcao19TextController;
  String? Function(BuildContext, String?)? opcao19TextControllerValidator;
  // State field(s) for opcao1_10 widget.
  FocusNode? opcao110FocusNode;
  TextEditingController? opcao110TextController;
  String? Function(BuildContext, String?)? opcao110TextControllerValidator;
  // State field(s) for variacao_2 widget.
  FocusNode? variacao2FocusNode;
  TextEditingController? variacao2TextController;
  String? Function(BuildContext, String?)? variacao2TextControllerValidator;
  // State field(s) for opcao2_1 widget.
  FocusNode? opcao21FocusNode;
  TextEditingController? opcao21TextController;
  String? Function(BuildContext, String?)? opcao21TextControllerValidator;
  // State field(s) for opcao2_2 widget.
  FocusNode? opcao22FocusNode;
  TextEditingController? opcao22TextController;
  String? Function(BuildContext, String?)? opcao22TextControllerValidator;
  // State field(s) for opcao2_3 widget.
  FocusNode? opcao23FocusNode;
  TextEditingController? opcao23TextController;
  String? Function(BuildContext, String?)? opcao23TextControllerValidator;
  // State field(s) for opcao2_4 widget.
  FocusNode? opcao24FocusNode;
  TextEditingController? opcao24TextController;
  String? Function(BuildContext, String?)? opcao24TextControllerValidator;
  // State field(s) for opcao2_5 widget.
  FocusNode? opcao25FocusNode;
  TextEditingController? opcao25TextController;
  String? Function(BuildContext, String?)? opcao25TextControllerValidator;
  // State field(s) for opcao2_6 widget.
  FocusNode? opcao26FocusNode;
  TextEditingController? opcao26TextController;
  String? Function(BuildContext, String?)? opcao26TextControllerValidator;
  // State field(s) for opcao2_7 widget.
  FocusNode? opcao27FocusNode;
  TextEditingController? opcao27TextController;
  String? Function(BuildContext, String?)? opcao27TextControllerValidator;
  // State field(s) for opcao2_8 widget.
  FocusNode? opcao28FocusNode;
  TextEditingController? opcao28TextController;
  String? Function(BuildContext, String?)? opcao28TextControllerValidator;
  // State field(s) for opcao2_9 widget.
  FocusNode? opcao29FocusNode;
  TextEditingController? opcao29TextController;
  String? Function(BuildContext, String?)? opcao29TextControllerValidator;
  // State field(s) for opcao2_10 widget.
  FocusNode? opcao210FocusNode;
  TextEditingController? opcao210TextController;
  String? Function(BuildContext, String?)? opcao210TextControllerValidator;
  ...
  // State field(s) for SwitchEnvio widget.
  bool? switchEnvioValue;
  // State field(s) for SwitchFrete widget.
  bool? switchFreteValue;
  // State field(s) for SwitchCapsula widget.
  bool? switchCapsulaValue;
  ...
  void dispose() {
    ...
    variacao1FocusNode?.dispose();
    variacao1TextController?.dispose();

    opcao11FocusNode?.dispose();
    opcao11TextController?.dispose();

    opcao12FocusNode?.dispose();
    opcao12TextController?.dispose();

    opcao13FocusNode?.dispose();
    opcao13TextController?.dispose();

    opcao14FocusNode?.dispose();
    opcao14TextController?.dispose();

    opcao15FocusNode?.dispose();
    opcao15TextController?.dispose();

    opcao16FocusNode?.dispose();
    opcao16TextController?.dispose();

    opcao17FocusNode?.dispose();
    opcao17TextController?.dispose();

    opcao18FocusNode?.dispose();
    opcao18TextController?.dispose();

    opcao19FocusNode?.dispose();
    opcao19TextController?.dispose();

    opcao110FocusNode?.dispose();
    opcao110TextController?.dispose();

    variacao2FocusNode?.dispose();
    variacao2TextController?.dispose();

    opcao21FocusNode?.dispose();
    opcao21TextController?.dispose();

    opcao22FocusNode?.dispose();
    opcao22TextController?.dispose();

    opcao23FocusNode?.dispose();
    opcao23TextController?.dispose();

    opcao24FocusNode?.dispose();
    opcao24TextController?.dispose();

    opcao25FocusNode?.dispose();
    opcao25TextController?.dispose();

    opcao26FocusNode?.dispose();
    opcao26TextController?.dispose();

    opcao27FocusNode?.dispose();
    opcao27TextController?.dispose();

    opcao28FocusNode?.dispose();
    opcao28TextController?.dispose();

    opcao29FocusNode?.dispose();
    opcao29TextController?.dispose();

    opcao210FocusNode?.dispose();
    opcao210TextController?.dispose();
