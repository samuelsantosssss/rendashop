...
import 'login_p_c_principal_model.dart';
export 'login_p_c_principal_model.dart';

/// New Component Gen
class LoginPCPrincipalWidget extends StatefulWidget {
  const LoginPCPrincipalWidget({super.key});

  @override
  State<LoginPCPrincipalWidget> createState() => _LoginPCPrincipalWidgetState();
}

class _LoginPCPrincipalWidgetState extends State<LoginPCPrincipalWidget>
    with TickerProviderStateMixin {
  late LoginPCPrincipalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LoginPCPrincipalModel());
