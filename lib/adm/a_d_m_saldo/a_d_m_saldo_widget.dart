...
import 'a_d_m_saldo_model.dart';
export 'a_d_m_saldo_model.dart';

class ADMSaldoWidget extends StatefulWidget {
  const ADMSaldoWidget({super.key});

  static String routeName = 'ADM_saldo';
  static String routePath = '/aDMSaldo';

  @override
  State<ADMSaldoWidget> createState() => _ADMSaldoWidgetState();
}

class _ADMSaldoWidgetState extends State<ADMSaldoWidget> {
  late ADMSaldoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ADMSaldoModel());
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    20.0, 0.0, 10.0, 0.0),
                                            child: Text(
                                              'R\$ ${functions.valorDoubleEmString(listViewPedidosTotalRecord.comissaoRendaShop)}',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
