...
class RastreadorPedido2Widget extends StatefulWidget {
  const RastreadorPedido2Widget({
    super.key,
  ...
  static String routeName = 'Rastreador_Pedido2';
  static String routePath = '/rastreadorPedido2';

  @override
  State<RastreadorPedido2Widget> createState() =>
      _RastreadorPedido2WidgetState();
}

class _RastreadorPedido2WidgetState extends State<RastreadorPedido2Widget> {
  late RastreadorPedido2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RastreadorPedido2Model());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<PedidosTotalRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final rastreadorPedido2PedidosTotalRecord = snapshot.data!;
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: Column(
                                mainAxisSize: MainAxisSize.max,
                                children: [
                                  if (rastreadorPedido2PedidosTotalRecord
                                          .status ==
                                      'finalizado')
                                    Align(
                                      alignment:
                                      ...
                                      child: Padding(
                                        ...
                                        child: Text(
                                          'Entregue em ${dateTimeFormat(
                                            "yMMMd",
                                            rastreadorPedido2PedidosTotalRecord
                                                .dataEntregue,
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Icon(
                                          Icons.circle_sharp,
                                          color: rastreadorPedido2PedidosTotalRecord
                                                      .status ==
                                                  'finalizado'
                                              ? FlutterFlowTheme.of(context)
                                                  .secondary
                                              ...
                                              InkWell(
                                                ...
                                                onTap: () async {
                                                  await Clipboard.setData(
                                                      ClipboardData(
                                                          text: rastreadorPedido2PedidosTotalRecord
                                                              .codigoRastreio));
                                                },
                                                child: Row(
                                                  mainAxisSize:
