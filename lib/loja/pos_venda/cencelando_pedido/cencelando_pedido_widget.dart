...
class CencelandoPedidoWidget extends StatefulWidget {
  const CencelandoPedidoWidget({
    super.key,
    this.pedidoRef,
  });
  ...
  @override
  State<CencelandoPedidoWidget> createState() => _CencelandoPedidoWidgetState();
}

class _CencelandoPedidoWidgetState extends State<CencelandoPedidoWidget> {
  late CencelandoPedidoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CencelandoPedidoModel());
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await CancelamentoRecord.createDoc(
                                ...
                                produtoRef: stackPedidosTotalRecord.produtoRef,
                              ));
                              if ((_model.checkbox1Value == true) ||
                                  (_model.checkbox2Value == true) ||
                                  (_model.checkbox3Value == true)) {
