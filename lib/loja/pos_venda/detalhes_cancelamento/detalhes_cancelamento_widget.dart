...
class DetalhesCancelamentoWidget extends StatefulWidget {
  const DetalhesCancelamentoWidget({
    super.key,
  ...
  static String routeName = 'Detalhes_cancelamento';
  static String routePath = '/detalhesCancelamento';

  @override
  State<DetalhesCancelamentoWidget> createState() =>
      _DetalhesCancelamentoWidgetState();
}

class _DetalhesCancelamentoWidgetState
    extends State<DetalhesCancelamentoWidget> {
  late DetalhesCancelamentoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetalhesCancelamentoModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<PedidosTotalRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final detalhesCancelamentoPedidosTotalRecord = snapshot.data!;
                                          ...
                                          Padding(
                                            ...
                                            child: StreamBuilder<LojasRecord>(
                                              stream: LojasRecord.getDocument(
                                                  detalhesCancelamentoPedidosTotalRecord
                                                      .lojaRef!),
                                              builder: (context, snapshot) {
                                                // Customize what your widget looks like when it's loading.
                                                if (!snapshot.hasData) {
                                                              ...
                                                              padding:
                                                                  EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          0.0),
                                                              child: Text(
                                                                'x${detalhesCancelamentoPedidosTotalRecord.quantidade.toString()}',
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodyMedium
                                                                    .override(
                                                              ...
                                                              padding:
                                                                  EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          4.0),
                                                              child: Text(
                                                                'R\$${functions.valorDoubleEmString(detalhesCancelamentoPedidosTotalRecord.precoAntes)}',
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodyMedium
                                                                    .override(
                                                              ...
                                                              padding:
                                                                  EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          4.0),
                                                              child: Text(
                                                                'R\$${functions.valorDoubleEmString(detalhesCancelamentoPedidosTotalRecord.preco)}',
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodyMedium
                                                                    .override(
                                                              ...
                                                              padding:
                                                                  EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          7.0),
                                                              child: Text(
                                                                'Total de ${detalhesCancelamentoPedidosTotalRecord.quantidade.toString()} item: ',
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodyMedium
                                                                    .override(
