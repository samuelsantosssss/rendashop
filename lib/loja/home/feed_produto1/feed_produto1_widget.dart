...
import 'feed_produto1_model.dart';
export 'feed_produto1_model.dart';

class FeedProduto1Widget extends StatefulWidget {
  const FeedProduto1Widget({super.key});

  @override
  State<FeedProduto1Widget> createState() => _FeedProduto1WidgetState();
}

class _FeedProduto1WidgetState extends State<FeedProduto1Widget> {
  late FeedProduto1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FeedProduto1Model());
        ...
        children: [
                    ...
                    builder: (context, snapshot) {
                      ...
                      return Container(
                        ...
                        child: Builder(
                          builder: (context) {
                            final banner =
                                containerBannerRecord?.listaBanner.toList() ??
                                    [];
                ...
                children: [
                  Padding(
                    ...
                    child: Container(
                      width: double.infinity,
                      height: valueOrDefault<double>(
                        (MediaQuery.sizeOf(context).width >= 500.0 ? 200 : 313)
                            .toDouble(),
                        313.0,
                      ),
                      decoration: BoxDecoration(
                                                        ...
                                                        image: DecorationImage(
                                                          ...
                                                          alignment:
                                                              AlignmentDirectional(
                                                                  0.0, 0.0),
                                                          image: Image.network(
                                                            'https://res.cloudinary.com/dul9tr5i1/image/upload/f_webp,q_auto/zyyktrllzxxy4wmnel1v',
                                                          ).image,
                                                        ),
                                                        borderRadius:
                                                            BorderRadius.only(
          ...
          StreamBuilder<List<ProdutoRecord>>(
            ...
            builder: (context, snapshot) {
              ...
              List<ProdutoRecord> relampago1ProdutoRecordList = snapshot.data!;
              ...
              return Container(
                ...
                child: Visibility(
                  ...
                  child: Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(10.0, 11.0, 10.0, 0.0),
                    child: Container(
                      width: double.infinity,
                      height: 257.6,
                      decoration: BoxDecoration(
                        ...
                        children: [
                          InkWell(
                            ...
                            onTap: () async {
                              ...
                              safeSetState(() {});
                              FFAppState().promoCor = functions
                                  .promoRelampagoCor(FFAppState().horaPromo);
                              safeSetState(() {});
                                      ...
                                      child: Builder(
                                        builder: (context) {
                                          ...
                                          return ListView.builder(
                                            ...
                                            itemBuilder:
                                                (context, produtoListIndex) {
                                              final produtoListItem =
                                                  produtoList[produtoListIndex];
                                              return Align(
                                                alignment: AlignmentDirectional(
                                                    0.0, 0.0),
                                                child: Padding(
          ...
          StreamBuilder<List<ProdutoRecord>>(
            ...
            builder: (context, snapshot) {
              ...
              List<ProdutoRecord> feed3ProdutoRecordList = snapshot.data!;
