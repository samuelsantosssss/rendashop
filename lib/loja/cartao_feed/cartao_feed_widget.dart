...
import 'cartao_feed_model.dart';
export 'cartao_feed_model.dart';

class CartaoFeedWidget extends StatefulWidget {
  const CartaoFeedWidget({
    super.key,
    required this.valor,
  });
  ...
  @override
  State<CartaoFeedWidget> createState() => _CartaoFeedWidgetState();
}

class _CartaoFeedWidgetState extends State<CartaoFeedWidget> {
  late CartaoFeedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CartaoFeedModel());
