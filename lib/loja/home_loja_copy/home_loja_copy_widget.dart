...
import 'home_loja_copy_model.dart';
export 'home_loja_copy_model.dart';

class HomeLojaCopyWidget extends StatefulWidget {
  const HomeLojaCopyWidget({super.key});

  static String routeName = 'Home-lojaCopy';
  static String routePath = '/homeLojaCopy';

  @override
  State<HomeLojaCopyWidget> createState() => _HomeLojaCopyWidgetState();
}

class _HomeLojaCopyWidgetState extends State<HomeLojaCopyWidget> {
  late HomeLojaCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeLojaCopyModel());
