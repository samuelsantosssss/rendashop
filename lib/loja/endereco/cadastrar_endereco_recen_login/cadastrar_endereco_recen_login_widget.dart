...
import 'cadastrar_endereco_recen_login_model.dart';
export 'cadastrar_endereco_recen_login_model.dart';

class CadastrarEnderecoRecenLoginWidget extends StatefulWidget {
  const CadastrarEnderecoRecenLoginWidget({
    super.key,
  ...
  static String routeName = 'Cadastrar_enderecoRecenLogin';
  static String routePath = '/cadastrarEnderecoRecenLogin';

  @override
  State<CadastrarEnderecoRecenLoginWidget> createState() =>
      _CadastrarEnderecoRecenLoginWidgetState();
}

class _CadastrarEnderecoRecenLoginWidgetState
    extends State<CadastrarEnderecoRecenLoginWidget> {
  late CadastrarEnderecoRecenLoginModel _model;
