...
import 'cadastrar_endereco2_model.dart';
export 'cadastrar_endereco2_model.dart';

class CadastrarEndereco2Widget extends StatefulWidget {
  const CadastrarEndereco2Widget({super.key});

  static String routeName = 'Cadastrar_endereco2';
  static String routePath = '/cadastrarEndereco2';

  @override
  State<CadastrarEndereco2Widget> createState() =>
      _CadastrarEndereco2WidgetState();
}

class _CadastrarEndereco2WidgetState extends State<CadastrarEndereco2Widget> {
  late CadastrarEndereco2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadastrarEndereco2Model());
                              ...
                              if (_model.cepTextController.text != '') {
                                if (_model.textController4.text != '') {
                                  ...
                                  await currentUserReference!
                                    ...
                                    enderecoCompleto:
                                        _model.criado2?.enderecoCompleto,
                                    enderecoRef: _model.criado2?.reference,
