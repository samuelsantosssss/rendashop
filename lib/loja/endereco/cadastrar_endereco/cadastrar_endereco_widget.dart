...
class CadastrarEnderecoWidget extends StatefulWidget {
  ...
  static String routeName = 'Cadastrar_endereco';
  static String routePath = '/cadastrarEndereco';

  @override
  State<CadastrarEnderecoWidget> createState() =>
                        ...
                        Expanded(
                          child: Align(
                            ...
                            child: Container(
                              width: double.infinity,
                              child: TextFormField(
                                controller: _model.cpffTextController,
                                focusNode: _model.cpffFocusNode,
                                autofocus: false,
                                obscureText: false,
                                decoration: InputDecoration(
                                  isDense: false,
                                ...
                                cursorColor:
                                    FlutterFlowTheme.of(context).primaryText,
                                validator: _model.cpffTextControllerValidator
                                    .asValidator(context),
                                inputFormatters: [_model.cpffMask],
                              ),
                            ),
                          ),
                        ),
