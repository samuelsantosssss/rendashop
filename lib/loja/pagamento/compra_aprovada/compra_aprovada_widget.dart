...
import 'compra_aprovada_model.dart';
export 'compra_aprovada_model.dart';

class CompraAprovadaWidget extends StatefulWidget {
  const CompraAprovadaWidget({super.key});

  static String routeName = 'compraAprovada';
  static String routePath = '/compraAprovada';

  @override
  State<CompraAprovadaWidget> createState() => _CompraAprovadaWidgetState();
}

class _CompraAprovadaWidgetState extends State<CompraAprovadaWidget> {
  late CompraAprovadaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompraAprovadaModel());
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            'Você pagou ${FFAppState().totalPedido}',
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Parabéns pela compra! Já comunicamos o vendedor',
