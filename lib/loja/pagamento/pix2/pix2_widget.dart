...
import 'pix2_model.dart';
export 'pix2_model.dart';

class Pix2Widget extends StatefulWidget {
  const Pix2Widget({
    super.key,
  ...
  static String routeName = 'pix2';
  static String routePath = '/pix2';

  @override
  State<Pix2Widget> createState() => _Pix2WidgetState();
}

class _Pix2WidgetState extends State<Pix2Widget> {
  late Pix2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Pix2Model());
      ...
      builder: (context, snapshot) {
        ...
        if (!snapshot.hasData) {
          return Scaffold(
            ...
            body: Carregando15Widget(),
          );
        }

        final pix2PedidosTotalRecord = snapshot.data!;
                      ...
                      child: Column(
                        ...
                        children: [
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 0.0, 10.0, 0.0),
                                    child: Text(
                                      'R\$ ${pix2PedidosTotalRecord.totalGeralPedidos}',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            font: GoogleFonts.inter(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      wrapWithModel(
                                        model: _model.timePix3Model,
                                        updateCallback: () =>
                                            safeSetState(() {}),
                                        child: TimePix3Widget(
                                          vencimentoData:
                                              pix2PedidosTotalRecord.time24h!,
                                        ),
                                      ),
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                          ...
                          Builder(
                            builder: (context) {
                              final pedidosList =
                                  pix2PedidosTotalRecord.pedidosList.toList();
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Align(
                                                                      ...
                                                                      child:
                                                                          Text(
                                                                        functions
                                                                            .valorDoubleEmString(containerPedidosTotalRecord.totalPedido),
                                                                        style: FlutterFlowTheme.of(context)
                                                                            .bodyMedium
                                                                            .override(
                                                                              font: GoogleFonts.inter(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  FFAppState().totalPedido =
                                      pix2PedidosTotalRecord.totalGeralPedidos;
                                  safeSetState(() {});
                                },
                                text: 'OK',
                                options: FFButtonOptions(
