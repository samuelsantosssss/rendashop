...
class CadastrarCartaoWidget extends StatefulWidget {
  ...
  static String routeName = 'Cadastrar_cartao';
  static String routePath = '/cadastrarCartao';
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    5.0, 0.0, 0.0, 0.0),
                                child: Text(
                                  'As informações do seu cartão estão protegidas',
                        ...
                        Align(
                          ...
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                34.0, 3.0, 20.0, 0.0),
                            child: Text(
                              'Estabelecemos parcerias com plataformas de pagamento para garantir que os detalhes do seu cartão sejam bem protegidos. A Renda Shop não terá acesso às informações do seu cartão.',
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    font: GoogleFonts.inter(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: ClipRRect(
                            ...
                            child: Image.asset(
                              'assets/images/Ainda_no_Existem_Pedidos_(42).png',
                              width: 200.0,
                              height: 30.16,
                              fit: BoxFit.cover,
                            ),
