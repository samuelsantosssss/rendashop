...
import 'pagamento_reprovado2_model.dart';
export 'pagamento_reprovado2_model.dart';

class PagamentoReprovado2Widget extends StatefulWidget {
  const PagamentoReprovado2Widget({
    super.key,
    this.pedidoList,
  });

  final List<DocumentReference>? pedidoList;

  static String routeName = 'pagamentoReprovado2';
  static String routePath = '/pagamentoReprovado2';

  @override
  State<PagamentoReprovado2Widget> createState() =>
      _PagamentoReprovado2WidgetState();
}

class _PagamentoReprovado2WidgetState extends State<PagamentoReprovado2Widget> {
  late PagamentoReprovado2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PagamentoReprovado2Model());
                            ...
                            Flexible(
                              child: Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 0.0, 5.0, 0.0),
                                child: Text(
                                  'Seu pagamento foi rejeitado pela operadora do cartão. Por favor, entre em contato com o banco ou use outro método de pagamento.',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        font: GoogleFonts.inter(
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 5.0, 17.0, 0.0),
                                          child: Text(
                                            'R\$ ${functions.pagamentoReprovado2(FFAppState().totalPedido, FFAppState().produtosCartaoErro, FFAppState().freteCartaoErro)}',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  font: GoogleFonts.inter(
