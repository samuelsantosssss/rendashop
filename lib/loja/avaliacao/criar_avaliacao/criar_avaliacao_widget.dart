...
class CriarAvaliacaoWidget extends StatefulWidget {
  const CriarAvaliacaoWidget({
    super.key,
  ...
  static String routeName = 'criar_avaliacao';
  static String routePath = '/criarAvaliacao';

  @override
  State<CriarAvaliacaoWidget> createState() => _CriarAvaliacaoWidgetState();
}

class _CriarAvaliacaoWidgetState extends State<CriarAvaliacaoWidget> {
  late CriarAvaliacaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CriarAvaliacaoModel());
                              ...
                              children: [
                                RichText(
                                  ...
                                  text: TextSpan(
                                    children: [
                                      TextSpan(
                                        text: 'Deixe uma avaliação e ganhe até',
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ClipRRect(
                                        ...
                                        child: Image.network(
                                          containerPedidosTotalRecord.imagem,
                                          width: 43.0,
                                          height: 43.0,
                                          fit: BoxFit.cover,
                                        ),
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  10.0, 10.0, 0.0, 0.0),
                                          child: Text(
                                            containerPedidosTotalRecord.nome
                                                .maybeHandleOverflow(
                                              maxChars: 31,
                                              replacement: '…',
                                            ),
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          10.0, 0.0, 0.0, 0.0),
                                      child: Text(
                                        'Adicione 1 foto(s) e/ou vídeos(s)',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.inter(
                                                      ...
                                                      if (selectedMedia !=
                                                          ...
                                                          selectedMedia.every((m) =>
                                                              validateFileFormat(
                                                                  ...
                                                                  context))) {
                                                        safeSetState(() => _model
                                                                .isDataUploading_uploadData33f4555 =
                                                            true);
                                                        ...
                                                        try {
                                                          ...
                                                          _model.isDataUploading_uploadData33f4555 =
                                                              false;
                                                        }
                                                        if (selectedUploadedFiles
                                                            ...
                                                            downloadUrls
                                                                ...
                                                                selectedMedia
                                                                    .length) {
                                                          safeSetState(() {
                                                            _model.uploadedLocalFiles_uploadData33f4555 =
                                                                selectedUploadedFiles;
                                        ...
                                        child: Container(
                                          ...
                                          child: TextFormField(
                                            ...
                                            decoration: InputDecoration(
                                              ...
                                              hintText:
                                                  'Ajude outras pessoas compartilhando suas experiências e ainda ganhe moedas!',
                                              hintStyle:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyLarge
                                                      .override(
                ...
                child: Container(
                  ...
                  child: StreamBuilder<PedidosTotalRecord>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      final columnPedidosTotalRecord = snapshot.data!;
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    5.0, 0.0, 0.0, 0.0),
                                            child: Text(
                                              'Siga as instruções para ganhar',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
