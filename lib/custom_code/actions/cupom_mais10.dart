...
Future<bool> cupomMais10(List<CarrinhoRecord> query) async {
  ...
  for (final doc in query) {
    // Verifica se o campo 'preco' é maior ou igual a 10
    if (doc.preco != null && doc.preco! >= 10) {
      print(
  ...
  print('Nenhum documento possui preco >= 10');
  return false;
}
