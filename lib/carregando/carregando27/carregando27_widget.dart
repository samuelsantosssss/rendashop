...
import 'carregando27_model.dart';
export 'carregando27_model.dart';

class Carregando27Widget extends StatefulWidget {
  const Carregando27Widget({super.key});

  @override
  State<Carregando27Widget> createState() => _Carregando27WidgetState();
}

class _Carregando27WidgetState extends State<Carregando27Widget> {
  late Carregando27Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Carregando27Model());
