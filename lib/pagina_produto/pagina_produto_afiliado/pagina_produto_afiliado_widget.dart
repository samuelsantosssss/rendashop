...
import '/pagina_produto/pagina_produto_afiliado_scroll/pagina_produto_afiliado_scroll_widget.dart';
...
import 'pagina_produto_afiliado_model.dart';
export 'pagina_produto_afiliado_model.dart';

class PaginaProdutoAfiliadoWidget extends StatefulWidget {
  const PaginaProdutoAfiliadoWidget({
    super.key,
    required this.produtoRef2,
  });

  final DocumentReference? produtoRef2;

  static String routeName = 'Pagina_produtoAfiliado';
  static String routePath = '/paginaProdutoafl';

  @override
  State<PaginaProdutoAfiliadoWidget> createState() =>
      _PaginaProdutoAfiliadoWidgetState();
}

class _PaginaProdutoAfiliadoWidgetState
    extends State<PaginaProdutoAfiliadoWidget> with TickerProviderStateMixin {
  late PaginaProdutoAfiliadoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PaginaProdutoAfiliadoModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<CarrinhoRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CarrinhoRecord> paginaProdutoAfiliadoCarrinhoRecordList =
            snapshot.data!;
          ...
          child: Scaffold(
            ...
            body: StreamBuilder<ProdutoAfiliadoRecord>(
              ...
              builder: (context, snapshot) {
                ...
                final stackProdutoAfiliadoRecord = snapshot.data!;
                ...
                return Stack(
                  children: [
                      ...
                      builder: (context, snapshot) {
                        ...
                        return Container(
                          ...
                          child: custom_widgets.EndOfScrollTrigger(
                            ...
                            child: () => PaginaProdutoAfiliadoScrollWidget(
                              produtoRef2: stackProdutoAfiliadoRecord.reference,
                            ),
                          ),
                        );
                      },
                    ...
                    if ((FFAppState().bennerBaixarAPP == false) && isWeb)
                      InkWell(
                        ...
                        onTap: () async {
                          ...
                          FFAppState().status = 'paginaProdutoAfiliado';
                          safeSetState(() {});
                    ...
                    Align(
                      ...
                      child: FutureBuilder<ProdutoRecord>(
                        future: ProdutoRecord.getDocumentOnce(
                            stackProdutoAfiliadoRecord.produtoRef!),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
                          if (!snapshot.hasData) {
                            return Center(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          await Clipboard.setData(ClipboardData(
                                              text: stackProdutoAfiliadoRecord
                                                  .linkProduto));
                                        },
                                        child: Container(
                                          width:
                                                                  ...
                                                                  if (currentUserReference !=
                                                                    ...
                                                                    if (functions.addCardEvitarDuplicar(
                                                                      ...
                                                                      await CarrinhoRecord.createDoc(
                                                                        ...
                                                                        dataAdicao:
                                                                            getCurrentTimestamp,
                                                                        fotoCapa: containerVarianteRecord?.foto != null &&
                                                                                containerVarianteRecord?.foto != ''
                                                                            ? containerVarianteRecord?.foto
                                                                            : carinhoVarianteOpc1Opc2ProdutoRecord.imagens.firstOrNull,
                                                                        titulo:
                                                                    ...
                                                                    if (carinhoVarianteOpc1Opc2ProdutoRecord
                                                                      ...
                                                                      FFAppState().CarrinhoTemporarioNacional = functions
                                                                          .addCarrinhoTemporario(
                                                                              getCurrentTimestamp,
                                                                              containerVarianteRecord?.foto != null && containerVarianteRecord?.foto != '' ? containerVarianteRecord!.foto : carinhoVarianteOpc1Opc2ProdutoRecord.imagens.firstOrNull!,
                                                            ...
                                                            if (loggedIn) {
                                                              ...
                                                              if (functions.addCardEvitarDuplicar(
                                                                ...
                                                                await CarrinhoRecord
                                                                  ...
                                                                  dataAdicao:
                                                                      getCurrentTimestamp,
                                                                  fotoCapa: text4444fotoVarianteRecord?.foto !=
                                                                              null &&
                                                              ...
                                                              await currentUserReference!
                                                                ...
                                                                valorTotalCompra: functions.contaMultiplicacao(
                                                                    carinhoVarianteOpc1Opc2ProdutoRecord
                                                                        .vendas
                                                                        .toDouble(),
                                                                    FFAppState()
                                                              ...
                                                              if (carinhoVarianteOpc1Opc2ProdutoRecord
                                                                ...
                                                                FFAppState().CarrinhoTemporarioNacional = functions
                                                                    .addCarrinhoTemporario(
                                                                        getCurrentTimestamp,
                                                                        text4444fotoVarianteRecord?.foto != null && text4444fotoVarianteRecord?.foto != ''
                                                                            ? text4444fotoVarianteRecord!
                                                                                .foto
                                                                            : carinhoVarianteOpc1Opc2ProdutoRecord
                                                                                .imagens.firstOrNull!,
                                      ...
                                      child: Padding(
                                        ...
                                        child: FutureBuilder<ProdutoRecord>(
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            final carinhoVarianteOpc12ProdutoRecord =
                                                snapshot.data!;
                                                          ...
                                                          return InkWell(
                                                            ...
                                                            onTap: () async {
                                                              if (currentUserReference !=
                                                                ...
                                                                if (carinhoVarianteOpc12ProdutoRecord
                                                                        .envioNaciona ==
                                                                    true) {
                                                                  FFAppState().CarrinhoTemporarioNacional = functions
                                                                      .addCarrinhoTemporario(
                                                                          getCurrentTimestamp,
                                                                          textFotoVarianteRecord?.foto != null && textFotoVarianteRecord?.foto != ''
                                                                              ? textFotoVarianteRecord!
                                                                                  .foto
                                                                              : carinhoVarianteOpc12ProdutoRecord
                                                                                  .imagens.firstOrNull!,
                                                            ...
                                                            if (currentUserReference !=
                                                              ...
                                                              if (functions.addCardEvitarDuplicar(
                                                                ...
                                                                await CarrinhoRecord
                                                                  ...
                                                                  userRef:
                                                                      currentUserReference,
                                                                  itens: textSemFotoVarianteRecord
                                                                      .produtoRef,
                                                                  quantidade:
                                                                      FFAppState()
                                                                          .quantidadeProduto,
                                                              ...
                                                              if (carinhoVarianteOpc12ProdutoRecord
                                                                ...
                                                                FFAppState().CarrinhoTemporarioNacional = functions
                                                                    .addCarrinhoTemporario(
                                                                        getCurrentTimestamp,
                                                                        textSemFotoVarianteRecord?.foto != null && textSemFotoVarianteRecord?.foto != ''
                                                                            ? textSemFotoVarianteRecord!
                                                                                .foto
                                                                            : carinhoVarianteOpc12ProdutoRecord
                                                                                .imagens.firstOrNull!,
                                            ...
                                            valueOrDefault<String>(
                                              currentUserReference != null
                                                  ? functions.somarQuantidadesTotal(
                                                      paginaProdutoAfiliadoCarrinhoRecordList
                                                          .toList())
                                                  : FFAppState()
                                                      .quantidadeCarrinho
                                                      .toString(),
                    ...
                    if ((FFAppState().verCarrinhoAfiliado == true) &&
                        (loggedIn == false))
                      Align(
                        alignment: AlignmentDirectional(0.0, 0.0),
                        child: Container(
                                                                  ...
                                                                  decoration:
                                                                    ...
                                                                    image:
                                                                      ...
                                                                      image: Image
                                                                          .network(
                                                                        functions
                                                                            .carrinhoTemporarioImg(lisjaCarrinhoItem),
                                                                      ).image,
                                                                    ),
                                                                    borderRadius:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      decoration:
                                                                        ...
                                                                        image:
                                                                          ...
                                                                          image:
                                                                              Image.network(
                                                                            listViewCarrinhoRecord.fotoCapa,
                                                                          ).image,
                                                                        ),
                                                                        borderRadius:
                    ...
                    StreamBuilder<ProdutoRecord>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return Container(
                          ...
                          decoration: BoxDecoration(),
                          child: wrapWithModel(
                            model: _model.atualizarAfiliadoProdutoModel,
                            updateCallback: () => safeSetState(() {}),
                            child: AtualizarAfiliadoProdutoWidget(
                              produtoRef:
                                  stackProdutoAfiliadoRecord.produtoRef!,
                              afiliadoProRef:
                                  stackProdutoAfiliadoRecord.reference,
                              dataAtualizacaoProduto:
                                  containerProdutoRecord.ultimaAtualizacao,
                              dataAtualizacaoAfiliado:
                                  stackProdutoAfiliadoRecord.ultimaAtualizacao,
                              exiteVariante: (stackProdutoAfiliadoRecord
                                      .valorComRef.isNotEmpty) ==
                                  true,
                            ),
                          ),
                        );
