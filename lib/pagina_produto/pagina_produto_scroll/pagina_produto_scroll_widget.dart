...
import 'pagina_produto_scroll_model.dart';
export 'pagina_produto_scroll_model.dart';

class PaginaProdutoScrollWidget extends StatefulWidget {
  const PaginaProdutoScrollWidget({
    super.key,
  ...
  @override
  State<PaginaProdutoScrollWidget> createState() =>
      _PaginaProdutoScrollWidgetState();
}

class _PaginaProdutoScrollWidgetState extends State<PaginaProdutoScrollWidget> {
  late PaginaProdutoScrollModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PaginaProdutoScrollModel());
  ...
  Widget build(BuildContext context) {
    ...
    return Align(
      ...
      child: FutureBuilder<ProdutoRecord>(
        future: (_model.documentRequestCompleter ??= Completer<ProdutoRecord>()
              ..complete(ProdutoRecord.getDocumentOnce(widget.produtoRef!)))
            .future,
        builder: (context, snapshot) {
          ...
          final queryProdutProdutoRecord = snapshot.data!;
            ...
            child: Column(
              ...
              children: [
                  ...
                  height: valueOrDefault<double>(
                    MediaQuery.sizeOf(context).width >= 500.0
                        ...
                        : valueOrDefault<double>(
                            queryProdutProdutoRecord.margem == 'story'
                                ? 549.1
                                : 432.4,
                            432.4,
                          ),
                  ...
                  child: Stack(
                    children: [
                      Builder(
                        builder: (context) {
                          final imageList =
                              queryProdutProdutoRecord.imagens.toList();
                                ...
                                itemBuilder: (context, imageListIndex) {
                                  ...
                                  return Stack(
                                    children: [
                                                  ...
                                                  Align(
                                                    alignment:
                                                        AlignmentDirectional(
                                                            0.0, 0.0),
                                                    child: Text(
                                                      '${functions.aumentar1numero(imageListIndex).toString()}/${queryProdutProdutoRecord.imagens.length.toString()}',
                                      ...
                                      if (queryProdutProdutoRecord.envioNaciona)
                                        Align(
                                          alignment:
                                              AlignmentDirectional(1.0, -1.0),
                                          child: Padding(
                                                ...
                                                child: Padding(
                                                  padding: EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          3.0, 0.0, 0.0, 5.0),
                                                  child: Text(
                                                    'R\$${functions.valorDoubleEmString(queryProdutProdutoRecord.precoAntes)}',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                        .override(
                                      ...
                                      child: Padding(
                                        ...
                                        child:
                                          ...
                                          stream: queryVarianteRecord(
                                            parent: queryProdutProdutoRecord
                                                .reference,
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  mainAxisSize: MainAxisSize.max,
                                  children: [
                                    if (queryProdutProdutoRecord.vendas >= 1)
                                      Align(
                                        alignment:
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 0.0, 3.0, 5.0),
                                          child: Text(
                                            '${functions.formatNumber(queryProdutProdutoRecord.vendas)} Vendidos (s)',
                                    ...
                                    if ((currentUserDocument?.favorito
                                                    .toList() ??
                                                [])
                                            .contains(widget.produtoRef?.id) ==
                                        true)
                      ...
                      if (queryProdutProdutoRecord.promoRelampagoAgendado ==
                          true)
                        Align(
                ...
                Align(
                  ...
                  child: Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(10.0, 9.0, 10.0, 0.0),
                    child: Text(
                      queryProdutProdutoRecord.nome,
                ...
                StreamBuilder<List<ProdutoRecord>>(
                  stream: queryProdutoRecord(
                    queryBuilder: (produtoRecord) => produtoRecord
                        .where(
                          'categoria',
                          isEqualTo: queryProdutProdutoRecord.categoria,
                        )
                      ...
                      child: Visibility(
                        ...
                        child: Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              context.pushNamed(
                                MaisVendidoWidget.routeName,
                                queryParameters: {
                                  'categoria': serializeParam(
                                    queryProdutProdutoRecord.categoria,
                                    ParamType.String,
                                  ),
                                }.withoutNulls,
                              );
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        6.0, 0.0, 0.0, 0.0),
                                    child: Text(
                                      'em ${queryProdutProdutoRecord.categoria}'
                                          .maybeHandleOverflow(
                                        maxChars: 23,
                                        replacement: '…',
                                      ),
                ...
                if (((queryProdutProdutoRecord.varianteImgList.isNotEmpty) ==
                        true) &&
                    (queryProdutProdutoRecord.titulo2 != ''))
                  Padding(
                    padding:
                    ...
                    child: StreamBuilder<List<VarianteRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        final variantes2opcFotoVarianteRecord =
                            variantes2opcFotoVarianteRecordList.isNotEmpty
                                ? variantes2opcFotoVarianteRecordList.first
                                : null;
                                                      ...
                                                      padding:
                                                          EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  0.0),
                                                      child: Text(
                                                        variantes2opcFotoVarianteRecord!
                                                            .opcaoTitulo1,
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                ...
                if ((queryProdutProdutoRecord.titulo2 == '') &&
                    ((queryProdutProdutoRecord.varianteImgList.isNotEmpty) ==
                        true))
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(10.0, 10.0, 10.0, 0.0),
                    child: StreamBuilder<List<VarianteRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        final variantes1opcFotoVarianteRecord =
                            variantes1opcFotoVarianteRecordList.isNotEmpty
                                ? variantes1opcFotoVarianteRecordList.first
                                : null;
                                                      ...
                                                      padding:
                                                          EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  0.0),
                                                      child: Text(
                                                        variantes1opcFotoVarianteRecord!
                                                            .opcaoTitulo1,
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                      ...
                      stream: queryVarianteRecord(
                        ...
                        queryBuilder: (varianteRecord) => varianteRecord.where(
                          ...
                          isEqualTo: FFAppState().selecionarVariante1 != ''
                              ? FFAppState().selecionarVariante1
                              : queryProdutProdutoRecord
                                  .varianteTitulo1List.firstOrNull,
                        ),
                        singleRecord: true,
                      ),
                      builder: (context, snapshot) {
                        ...
                        List<VarianteRecord> variantes2opcVarianteRecordList =
                            snapshot.data!;
                        // Return an empty Container when the item does not exist.
                        if (snapshot.data!.isEmpty) {
                          return Container();
                        }
                        final variantes2opcVarianteRecord =
                            variantes2opcVarianteRecordList.isNotEmpty
                                ? variantes2opcVarianteRecordList.first
                                : null;
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            child: Container(
                                                              decoration:
                                                                ...
                                                                border:
                                                                    Border.all(
                                                                  color: variantes2opcVarianteRecord
                                                                              ?.opcaoTitulo1 ==
                                                                          opcao1ListttItem
                                                                      ? FlutterFlowTheme.of(
                                                                              context)
                  ...
                  Padding(
                    ...
                    child: StreamBuilder<List<VarianteRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<VarianteRecord> variantes1opcVarianteRecordList =
                            snapshot.data!;
                        final variantes1opcVarianteRecord =
                            variantes1opcVarianteRecordList.isNotEmpty
                                ? variantes1opcVarianteRecordList.first
                                : null;
                ...
                Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(10.0, 17.0, 0.0, 0.0),
                  child: Row(
                    mainAxisSize: MainAxisSize.max,
                    children: [
                      Padding(
                ...
                if (FFAppState().verComissao == true)
                  Align(
                    alignment: AlignmentDirectional(1.0, -1.0),
                    child: Padding(
                      padding:
                ...
                if (FFAppState().verComissao == false)
                  InkWell(
                    splashColor: Colors.transparent,
                    focusColor: Colors.transparent,
                    hoverColor: Colors.transparent,
                                        ...
                                        children: [
                                          ...
                                          if (queryProdutProdutoRecord
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                'Ganhe até R\$ ${functions.comissaoPerfilProduto(queryProdutProdutoRecord.preco != null ? queryProdutProdutoRecord.preco : queryProdutProdutoRecord.menorPrecoRevenda, queryProdutProdutoRecord.comissaoAfiliado.toDouble())}',
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
                                                    .override(
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  10.0, 3.0, 0.0, 0.0),
                                          child: Text(
                                            'pessoa que comprar com seu link',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  font: GoogleFonts.inter(
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      if (functions.freteMaisde20Boolean(
                                              functions.frete(() {
                                            if (FFAppState()
                                                        .enderecoTemporario !=
                                                    '') {
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    highlightColor: Colors.transparent,
                    onTap: () async {
                      FFAppState().garantia = 'garantia';
                      safeSetState(() {});

                      context.pushNamed(SegurancaWidget.routeName);
                    },
                    child: Container(
                      width: double.infinity,
                      height: 33.0,
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    highlightColor: Colors.transparent,
                    onTap: () async {
                      FFAppState().garantia = 'privacidade';
                      safeSetState(() {});
                ...
                if (queryProdutProdutoRecord.comentarioAtivo == true)
                  StreamBuilder<List<AvaliacaoRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<AvaliacaoRecord> avaliacao1AvaliacaoRecordList =
                          snapshot.data!;
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  Align(
                                                    ...
                                                    child: Icon(
                                                      Icons.star_rounded,
                                                      color: functions.avaliacaoMediaDouble(
                                                                  avaliacao1AvaliacaoRecordList
                                                                      .toList()) >=
                                                              1.0
                                                          ? Color(0xFFFFCC10)
                                                          : Color(0x4B5E5E58),
                                          ...
                                          Text(
                                            '(${avaliacao1AvaliacaoRecordList.length.toString()} opiniões)',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  font: GoogleFonts.inter(
                  ...
                  StreamBuilder<List<AvaliacaoRecord>>(
                    stream: queryAvaliacaoRecord(
                      ...
                      queryBuilder: (avaliacaoRecord) =>
                          avaliacaoRecord.orderBy('nota', descending: true),
                    ),
                    builder: (context, snapshot) {
                      // Customize what your widget looks like when it's loading.
                      if (!snapshot.hasData) {
                      ...
                      List<AvaliacaoRecord> avaliacaoAvaliacaoRecordList =
                          snapshot.data!;
                            ...
                            Padding(
                              ...
                              child: StreamBuilder<List<AvaliacaoRecord>>(
                                stream: queryAvaliacaoRecord(
                                  parent: widget.produtoRef,
                                  queryBuilder: (avaliacaoRecord) =>
                                      avaliacaoRecord.orderBy('videoSet',
                                          descending: true),
                                  limit: 3,
                                ),
                                builder: (context, snapshot) {
                                  ...
                                  return ListView.builder(
                                    ...
                                    itemCount:
                                        listViewAvaliacaoRecordList.length,
                                                                ...
                                                                children: [
                                                                  Align(
                                                                    ...
                                                                    child: Icon(
                                                                      Icons
                                                                          .star_rounded,
                                                                      color: listViewAvaliacaoRecord.nota >=
                                                                              1
                                                                          ? Color(
                                                                              0xFFFFCC10)
                                                                          : Color(
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      0.0),
                                                          child: Text(
                                                            '(${listViewAvaliacaoRecord.like.length.toString()})',
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodyMedium
                                                                .override(
                                                                    ...
                                                                    onTap:
                                                                      ...
                                                                      context
                                                                        ...
                                                                        queryParameters:
                                                                          ...
                                                                          'avaliacaoref':
                                                                              serializeParam(
                                                                            listViewAvaliacaoRecord.reference,
                                                                            ParamType.DocumentReference,
                                                                          ),
                                                                          'produtoRef':
                                                                              serializeParam(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          if ((listViewAvaliacaoRecord.videoSet == 2) &&
                                                                              (listImgIndex == 0))
                                                                            Align(
                                                                              alignment: AlignmentDirectional(0.0, 0.0),
                                                                              child: Container(
                                                                          ...
                                                                          if ((listViewAvaliacaoRecord.imageList.length >= 4) &&
                                                                              (listImgIndex == 2))
                                                                            Align(
                                                                              alignment: AlignmentDirectional(1.0, 1.0),
                                                                              child: Padding(
                                                                                ...
                                                                                child: Container(
                                                                                  ...
                                                                                  child: Row(
                                                                                    ...
                                                                                    children: [
                                                                                      ...
                                                                                      Text(
                                                                                        '+ ${functions.comentarioQuantidadeFoto(listViewAvaliacaoRecord.imageList.toList()).toString()}',
                                                                                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                              font: GoogleFonts.inter(
                                ...
                                children: [
                                  InkWell(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(
                                          'Ver Todas as Avaliações (${avaliacaoAvaliacaoRecordList.length.toString()})',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                font: GoogleFonts.inter(
                            ...
                            children: [
                              ...
                              Flexible(
                                child: Align(
                                  alignment: AlignmentDirectional(-1.0, -1.0),
                                  child: Text(
                                    queryProdutProdutoRecord.descricao,
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          font: GoogleFonts.inter(
                ...
                Padding(
                  ...
                  child: StreamBuilder<LojasRecord>(
                    stream: LojasRecord.getDocument(
                        queryProdutProdutoRecord.lojaRef!),
                    builder: (context, snapshot) {
                      // Customize what your widget looks like when it's loading.
                      if (!snapshot.hasData) {
                        return Center(
                      ...
                      final perfilLojaLojasRecord = snapshot.data!;
                          ...
                          context.pushNamed(
                            ...
                            queryParameters: {
                              'lojaRef': serializeParam(
                                perfilLojaLojasRecord.reference,
                                ParamType.DocumentReference,
                              ),
                            }.withoutNulls,
                          );
                                    ...
                                    Container(
                                      ...
                                      child: Image.network(
                                        valueOrDefault<String>(
                                          perfilLojaLojasRecord.fotoperfil,
                                        ...
                                        Container(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                StreamBuilder<
                                                    List<AvaliacaoLojaRecord>>(
                                                  stream:
                                                      queryAvaliacaoLojaRecord(
                                                    parent:
                                                        perfilLojaLojasRecord
                                                            .reference,
                                                  ),
                                                  builder: (context, snapshot) {
                                                    // Customize what your widget looks like when it's loading.
                                                    if (!snapshot.hasData) {
                                                      return AvaliacaoLojaWidget();
                                                    }
                                                    List<AvaliacaoLojaRecord>
                                                        containerAvaliacaoLojaRecordList =
                                                        snapshot.data!;
                ...
                if (FFAppState().limiteVistualizacaoProdutoHomePage != 0)
                  Align(
                    alignment: AlignmentDirectional(0.0, -1.0),
                ...
                Container(
                  ...
                  child: Visibility(
                    visible:
                        (FFAppState().FeedAntes == FFAppState().FeedDepois) &&
