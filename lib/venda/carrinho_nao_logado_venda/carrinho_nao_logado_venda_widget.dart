...
import 'carrinho_nao_logado_venda_model.dart';
export 'carrinho_nao_logado_venda_model.dart';

class CarrinhoNaoLogadoVendaWidget extends StatefulWidget {
  const CarrinhoNaoLogadoVendaWidget({super.key});

  static String routeName = 'CarrinhoNaoLogadoVenda';
  static String routePath = '/carrinhoNaoLogadoVenda';

  @override
  State<CarrinhoNaoLogadoVendaWidget> createState() =>
      _CarrinhoNaoLogadoVendaWidgetState();
}

class _CarrinhoNaoLogadoVendaWidgetState
    extends State<CarrinhoNaoLogadoVendaWidget> {
  late CarrinhoNaoLogadoVendaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CarrinhoNaoLogadoVendaModel());
                        ...
                        Align(
                          ...
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 8.0, 0.0, 0.0),
                            child: Text(
                              'Carrinho (${functions.somarQuantidadesCarrinhoSemLogin(FFAppState().CarrinhoTemporarioNacional.toList(), FFAppState().CarrinhoTemporarioInternacional.toList()).toString()})',
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    font: GoogleFonts.inter(
                          ...
                          child: Builder(
                            builder: (context) {
                              ...
                              return ListView.builder(
                                ...
                                itemBuilder: (context, listaStringIndex) {
                                                          ...
                                                          child: Stack(
                                                            alignment:
                                                                AlignmentDirectional(
                                                                    0.0, 0.0),
                                                            children: [
                                                              if (functions.carrinhoAfiliadTodosListaBoolean(
                                                                      FFAppState()
                                                                          .CarrinhoTemporarioNacional
                                                                          .toList()) ==
                                                                  false)
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        alignment: AlignmentDirectional(
                                                                            ...
                                                                            0.0),
                                                                        children: [
                                                                          if (functions.carrinhoAfiliadoSelecionadoBoolen(listaStringItem) ==
                                                                              false)
                                                                            Container(
                                                                              width: double.infinity,
                                                                              height: double.infinity,
                                                                    ...
                                                                    stream:
                                                                      ...
                                                                      queryBuilder: (produtoRecord) => produtoRecord
                                                                          .where(
                                                                            'categoria',
                                                                            isEqualTo:
                                                                                containerProdutoRecord.categoria,
                                                                          )
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        functions.calcularTotalDeQueriesAfiliado(
                                            functions
                                                .juntarListaCarrinhoAfiliado(
                                                    FFAppState()
                                                        .CarrinhoTemporarioNacional
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          if (functions.carrinhoAfiliadTodosListaBoolean(
                              ...
                              true) {
                            context
                                .pushNamed(LoginAfiliadoCardWidget.routeName);
