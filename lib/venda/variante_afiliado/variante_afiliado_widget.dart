...
class VarianteAfiliadoWidget extends StatefulWidget {
  const VarianteAfiliadoWidget({
    super.key,
    required this.produtoRef,
    required this.afiliadoProdRef,
  });

  final DocumentReference? produtoRef;
  final DocumentReference? afiliadoProdRef;

  @override
  State<VarianteAfiliadoWidget> createState() => _VarianteAfiliadoWidgetState();
}

class _VarianteAfiliadoWidgetState extends State<VarianteAfiliadoWidget>
    with TickerProviderStateMixin {
  late VarianteAfiliadoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VarianteAfiliadoModel());
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
                                                                ...
                                                                queryBuilder:
                                                                    (varianteRecord) =>
                                                                        varianteRecord
                                                                            .where(
                                                                              'foto',
                                                                              isEqualTo: stackVarianteRecord?.foto,
                                                                            )
                                                                            .where(
                                                                              'opcao_titulo2',
                                                                                    ...
                                                                                    children: [
                                                                                      ...
                                                                                      Align(
                                                                                        ...
                                                                                        child: Padding(
                                                                                          ...
                                                                                          child: Text(
                                                                                            functions.valorRealString(functions.valorProdutoAfiliado(cimaNaoSetadoOpc1VarianteRecord!.reference, containerProdutoAfiliadoRecord.valorComRef.toList())),
                                                                                            style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                                  font: GoogleFonts.inter(
                                                                                                    fontWeight: FontWeight.w500,
                                                                                                    fontStyle: FlutterFlowTheme.of(context).bodyMedium.fontStyle,
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onTap:
                                                                              ...
                                                                              FFAppState().selecionarVariante1foto = containerProdutoRecord.varianteImgList.firstOrNull!;
                                                                              safeSetState(() {});
                                                                            },
                                                                            child:
                                                                                Icon(
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    Align(
                                                                                      ...
                                                                                      child: Padding(
                                                                                        padding: EdgeInsetsDirectional.fromSTEB(3.0, 0.0, 0.0, 0.0),
                                                                                        child: Text(
                                                                                          functions.valorRealString(functions.valorProdutoAfiliado(cimaSetadoFotoVarianteRecord!.reference, containerProdutoAfiliadoRecord.valorComRef.toList())),
                                                                                          style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                                font: GoogleFonts.inter(
                                                                                                  fontWeight: FontWeight.w500,
                                                                                                  fontStyle: FlutterFlowTheme.of(context).bodyMedium.fontStyle,
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  Align(
                                                                                    ...
                                                                                    child: Padding(
                                                                                      padding: EdgeInsetsDirectional.fromSTEB(3.0, 0.0, 0.0, 0.0),
                                                                                      child: Text(
                                                                                        functions.valorRealString(containerProdutoAfiliadoRecord.menorPreco),
                                                                                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                              font: GoogleFonts.inter(
                                                                                                fontWeight: FontWeight.w500,
                                                                                                fontStyle: FlutterFlowTheme.of(context).bodyMedium.fontStyle,
                                                                                  ...
                                                                                  Align(
                                                                                    ...
                                                                                    child: Padding(
                                                                                      padding: EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 5.0),
                                                                                      child: Text(
                                                                                        functions.valorCentavosEmString(containerProdutoAfiliadoRecord.menorPreco),
                                                                                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                              font: GoogleFonts.inter(
                                                                                                fontWeight: FontWeight.w500,
                                                                                                fontStyle: FlutterFlowTheme.of(context).bodyMedium.fontStyle,
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Text(
                                                                                'Selecione ${containerProdutoRecord.titulo2}',
                                                                                style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                      font: GoogleFonts.inter(
                                                                                        fontWeight: FontWeight.w600,
                                                                                        fontStyle: FlutterFlowTheme.of(context).bodyMedium.fontStyle,
                                                                      ...
                                                                      Container(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          builder:
                                                                              (context) {
                                                                            final titulo2List =
                                                                                containerProdutoRecord.varianteTitulo2List.toList();

                                                                            return SingleChildScrollView(
                                                                              scrollDirection: Axis.horizontal,
                                                                              child: Row(
                                                                                mainAxisSize: MainAxisSize.max,
                                                                                children: List.generate(titulo2List.length, (titulo2ListIndex) {
                                                                        ...
                                                                        Row(
                                                                          ...
                                                                          children: [
                                                                            Align(
                                                                              alignment: AlignmentDirectional(0.0, 0.0),
                                                                              child: Padding(
                                                                                padding: EdgeInsetsDirectional.fromSTEB(5.0, 0.0, 3.0, 1.0),
                                                                                child: Icon(
                                                                                  Icons.info_outline,
                                                                                  color: Color(0xFFE9381B),
                                                                                  size: 13.0,
                                                                  ...
                                                                  if (currentUserReference !=
                                                                    ...
                                                                    if (functions.addCardEvitarDuplicar(
                                                                      ...
                                                                      await CarrinhoRecord.createDoc(
                                                                        ...
                                                                        dataAdicao:
                                                                            getCurrentTimestamp,
                                                                        fotoCapa: baixo2VarianteRecord?.foto != null &&
                                                                ...
                                                                queryBuilder:
                                                                    (varianteRecord) =>
                                                                        varianteRecord
                                                                            ...
                                                                            .where(
                                                                              'opcao_titulo1',
                                                                              isEqualTo: stackVarianteRecord?.opcaoTitulo1,
                                                                            ),
                                                                singleRecord:
                                                                    true,
                                                              ),
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    Align(
                                                                                      ...
                                                                                      child: Padding(
                                                                                        padding: EdgeInsetsDirectional.fromSTEB(3.0, 0.0, 0.0, 0.0),
                                                                                        child: Text(
                                                                                          functions.valorRealString(functions.valorProdutoAfiliado(naoEsetadoVarianteRecord!.reference, containerProdutoAfiliadoRecord.valorComRef.toList())),
                                                                                          style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                                font: GoogleFonts.inter(
                                                                                                  fontWeight: FontWeight.w500,
                                                                                                  fontStyle: FlutterFlowTheme.of(context).bodyMedium.fontStyle,
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onTap:
                                                                              ...
                                                                              Navigator.pop(context);
                                                                              FFAppState().adicionarCarrinho = false;
                                                                              FFAppState().selecionarVariante1 = containerProdutoRecord.varianteTitulo1List.firstOrNull!;
                                                                              safeSetState(() {});
                                                                            },
                                                                            child:
                                                                                Icon(
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    Align(
                                                                                      ...
                                                                                      child: Padding(
                                                                                        padding: EdgeInsetsDirectional.fromSTEB(3.0, 0.0, 0.0, 0.0),
                                                                                        child: Text(
                                                                                          functions.valorRealString(functions.valorProdutoAfiliado(cimaSetado2VarianteRecord!.reference, containerProdutoAfiliadoRecord.valorComRef.toList())),
                                                                                          style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                                font: GoogleFonts.inter(
                                                                                                  fontWeight: FontWeight.w500,
                                                                                                  fontStyle: FlutterFlowTheme.of(context).bodyMedium.fontStyle,
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            builder:
                                                                                (context) {
                                                                              final titulo1List = containerProdutoRecord.varianteTitulo1List.toList();
                                                                  ...
                                                                  child: Align(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        if (FFAppState().adicionarCarrinho ==
                                                                            false)
                                                                          Align(
                                                                            alignment:
                                                                                AlignmentDirectional(0.0, 0.0),
                                        ...
                                        child:
                                          ...
                                          stream: queryVarianteRecord(
                                            ...
                                            queryBuilder: (varianteRecord) =>
                                                varianteRecord.where(
                                              'titulo1',
                                              isEqualTo: containerProdutoRecord
                                                  .titulo1,
                                            ),
                                            singleRecord: true,
                                          ),
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      builder:
                                                                          (context) {
                                                                        final tituloList = containerProdutoRecord
                                                                            .varianteTitulo1List
                                                                            .toList();
                                                                        ...
                                                                        return SingleChildScrollView(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            mainAxisSize:
                                                                                MainAxisSize.max,
                                                                            children:
                                                                                List.generate(tituloList.length, (tituloListIndex) {
                                                                              final tituloListItem = tituloList[tituloListIndex];
                                                                              return Align(
                                                                                alignment: AlignmentDirectional(0.0, 0.0),
                                                                                child: Padding(
                                                                                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 13.0, 0.0),
        ...
        if ((FFAppState().verCarrinhoAfiliado == true) && (loggedIn == false))
          Align(
            alignment: AlignmentDirectional(0.0, 0.0),
            child: Container(
                                      ...
                                      child: Builder(
                                        builder: (context) {
                                          ...
                                          return ListView.builder(
                                            ...
                                            shrinkWrap: true,
                                            scrollDirection: Axis.horizontal,
                                            itemCount: lisjaCarrinho.length,
                                            itemBuilder:
                                                (context, lisjaCarrinhoIndex) {
                                              final lisjaCarrinhoItem =
                                                  lisjaCarrinho[
                                                      lisjaCarrinhoIndex];
                                              return Visibility(
                                                visible:
                                                    lisjaCarrinhoIndex <= 2,
                                                child: Align(
                                                  alignment:
                                                      AlignmentDirectional(
                                                          0.0, 0.0),
        ...
        if ((FFAppState().verCarrinhoLogado == true) && (loggedIn == true))
          Align(
            alignment: AlignmentDirectional(0.0, 0.0),
            child: Container(
              width: MediaQuery.sizeOf(context).width * 0.8,
