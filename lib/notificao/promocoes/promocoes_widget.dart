...
class _PromocoesWidgetState extends State<PromocoesWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PromocoesModel());
