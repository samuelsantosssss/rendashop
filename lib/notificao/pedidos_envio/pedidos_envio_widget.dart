...
import 'pedidos_envio_model.dart';
export 'pedidos_envio_model.dart';

class PedidosEnvioWidget extends StatefulWidget {
  const PedidosEnvioWidget({super.key});

  static String routeName = 'pedidosEnvio';
  static String routePath = '/pedidosenvio';

  @override
  State<PedidosEnvioWidget> createState() => _PedidosEnvioWidgetState();
}

class _PedidosEnvioWidgetState extends State<PedidosEnvioWidget> {
  late PedidosEnvioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PedidosEnvioModel());
                      ...
                      child: Column(
                        ...
                        children: [
                          ClipRRect(
                            ...
                            child: Image.network(
                              'https://firebasestorage.googleapis.com/v0/b/renda-shop-sat8qr.firebasestorage.app/o/Ainda%20n%C3%A3o%20Existem%20Pedidos%20(9).png?alt=media&token=4b40fd59-99fa-429a-aad8-6cc5a3509bbb',
                              width: 105.0,
                              height: 104.43,
                              fit: BoxFit.contain,
                            ),
                          ...
                          Text(
                            'Não há informações de logística',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  font: GoogleFonts.inter(
