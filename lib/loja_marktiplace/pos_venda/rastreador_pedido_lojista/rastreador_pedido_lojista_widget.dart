...
class RastreadorPedidoLojistaWidget extends StatefulWidget {
  const RastreadorPedidoLojistaWidget({
    super.key,
  ...
  static String routeName = 'Rastreador_Pedido_lojista';
  static String routePath = '/rastreadorPedidoLojista';

  @override
  State<RastreadorPedidoLojistaWidget> createState() =>
      _RastreadorPedidoLojistaWidgetState();
}

class _RastreadorPedidoLojistaWidgetState
    extends State<RastreadorPedidoLojistaWidget> {
  late RastreadorPedidoLojistaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RastreadorPedidoLojistaModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<PedidosTotalRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final rastreadorPedidoLojistaPedidosTotalRecord = snapshot.data!;
        ...
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            body: StreamBuilder<List<Rastreio2Record>>(
              ...
              builder: (context, snapshot) {
                ...
                List<Rastreio2Record> stackRastreio2RecordList = snapshot.data!;

                return Stack(
                  children: List.generate(stackRastreio2RecordList.length,
                      (stackIndex) {
                    final stackRastreio2Record =
                        stackRastreio2RecordList[stackIndex];
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: Column(
                                mainAxisSize: MainAxisSize.max,
                                children: [
                                  if (rastreadorPedidoLojistaPedidosTotalRecord
                                          .status ==
                                      'finalizado')
                                    Align(
                                      alignment:
                                      ...
                                      child: Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            10.0, 10.0, 0.0, 0.0),
                                        child: Text(
                                          'Entregue em ${dateTimeFormat(
                                            "yMMMd",
                                            rastreadorPedidoLojistaPedidosTotalRecord
                                                .dataEntregue,
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Icon(
                                          Icons.circle_sharp,
                                          color: rastreadorPedidoLojistaPedidosTotalRecord
                                                      .status ==
                                                  'finalizado'
                                              ? FlutterFlowTheme.of(context)
                                                  .secondary
                                              ...
                                              InkWell(
                                                ...
                                                onTap: () async {
                                                  await Clipboard.setData(
                                                      ClipboardData(
                                                          text: rastreadorPedidoLojistaPedidosTotalRecord
                                                              .codigoRastreio));
                                                },
                                                child: Row(
                                                  mainAxisSize:
                                  ...
                                  StreamBuilder<List<Rastreio2Record>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return ListView.builder(
                                        ...
                                        itemCount:
                                            listViewRastreio2RecordList.length,
