...
class DetalhesDoPedidoLogistaWidget extends StatefulWidget {
  const DetalhesDoPedidoLogistaWidget({
    super.key,
  ...
  static String routeName = 'Detalhes_do_pedido_logista';
  static String routePath = '/detalhesDoPedidoLogista';

  @override
  State<DetalhesDoPedidoLogistaWidget> createState() =>
      _DetalhesDoPedidoLogistaWidgetState();
}

class _DetalhesDoPedidoLogistaWidgetState
    extends State<DetalhesDoPedidoLogistaWidget> {
  late DetalhesDoPedidoLogistaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetalhesDoPedidoLogistaModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<PedidosTotalRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final detalhesDoPedidoLogistaPedidosTotalRecord = snapshot.data!;
                                                  ...
                                                  valueOrDefault<String>(
                                                    () {
                                                      if (detalhesDoPedidoLogistaPedidosTotalRecord
                                                          ...
                                                          'preparando') {
                                                        return 'Preparando';
                                                      } else if (detalhesDoPedidoLogistaPedidosTotalRecord
                                                              .status ==
                                                          'enviado') {
                                                        return 'Enviado';
                                                      } else if (detalhesDoPedidoLogistaPedidosTotalRecord
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  30.0, 2.0, 0.0, 0.0),
                                          child: Text(
                                            'Data do pagamento: ${dateTimeFormat(
                                              "yMMMd",
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(0.0, 5.0,
                                                                0.0, 0.0),
                                                    child: Text(
                                                      'Entrega padrão: ${detalhesDoPedidoLogistaPedidosTotalRecord.codigoRastreio}',
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                          .bodyMedium
                                                          .override(
                              ...
                              Align(
                                ...
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      36.0, 0.0, 30.0, 14.0),
                                  child: Text(
                                    'Rua Elis Regina 435, Itaquaquecetuba, São Paulo, 08594410',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          font: GoogleFonts.inter(
                                                ...
                                                child: Padding(
                                                  padding: EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 0.0, 10.0, 0.0),
                                                  child: Text(
                                                    'x${detalhesDoPedidoLogistaPedidosTotalRecord.quantidade.toString()}',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                        .override(
                                                ...
                                                child: Padding(
                                                  padding: EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 6.0, 10.0, 4.0),
                                                  child: Text(
                                                    'R\$${functions.valorDoubleEmString(detalhesDoPedidoLogistaPedidosTotalRecord.preco)}',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                        .override(
                                                ...
                                                child: Padding(
                                                  padding: EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 0.0, 4.0, 7.0),
                                                  child: Text(
                                                    'Total de ${detalhesDoPedidoLogistaPedidosTotalRecord.quantidade.toString()} item: ',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                        .override(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text(
                                            '#${detalhesDoPedidoLogistaPedidosTotalRecord.idPedido}',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  font: GoogleFonts.inter(
                          ...
                          Expanded(
                            child: Align(
                              ...
                              child: FFButtonWidget(
                                ...
                                text: 'Cadastrar codigo rastreio',
                                options: FFButtonOptions(
                                  width: MediaQuery.sizeOf(context).width * 0.8,
                                  height: 40.0,
                                  padding: EdgeInsetsDirectional.fromSTEB(
