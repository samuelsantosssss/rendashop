...
import 'criar_atualizacao_frete_model.dart';
export 'criar_atualizacao_frete_model.dart';

class CriarAtualizacaoFreteWidget extends StatefulWidget {
  const CriarAtualizacaoFreteWidget({
    super.key,
  ...
  @override
  State<CriarAtualizacaoFreteWidget> createState() =>
      _CriarAtualizacaoFreteWidgetState();
}

class _CriarAtualizacaoFreteWidgetState
    extends State<CriarAtualizacaoFreteWidget> {
  late CriarAtualizacaoFreteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CriarAtualizacaoFreteModel());
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(0.0, 10.0, 8.0, 10.0),
                    child: Container(
                      width: double.infinity,
                      child: TextFormField(
                  ...
                  Align(
                    ...
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(13.0, 0.0, 0.0, 5.0),
                      child: Text(
                        'Status Pedido',
