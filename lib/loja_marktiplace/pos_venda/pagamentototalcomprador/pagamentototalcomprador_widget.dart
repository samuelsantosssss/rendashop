...
class PagamentototalcompradorWidget extends StatefulWidget {
  const PagamentototalcompradorWidget({
    super.key,
  ...
  @override
  State<PagamentototalcompradorWidget> createState() =>
      _PagamentototalcompradorWidgetState();
}

class _PagamentototalcompradorWidgetState
    extends State<PagamentototalcompradorWidget> {
  late PagamentototalcompradorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PagamentototalcompradorModel());
                              ...
                              Padding(
                                ...
                                child: Text(
                                  functions.valorDoubleEmString(
                                      containerPedidosTotalRecord.totalPedido),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        font: GoogleFonts.inter(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        functions.valorDoubleEmString(
                                            containerPedidosTotalRecord.frete),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.inter(
