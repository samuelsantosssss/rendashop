...
import 'cadastrar_opcao22_model.dart';
export 'cadastrar_opcao22_model.dart';

class CadastrarOpcao22Widget extends StatefulWidget {
  const CadastrarOpcao22Widget({super.key});

  @override
  State<CadastrarOpcao22Widget> createState() => _CadastrarOpcao22WidgetState();
}

class _CadastrarOpcao22WidgetState extends State<CadastrarOpcao22Widget> {
  late CadastrarOpcao22Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadastrarOpcao22Model());
