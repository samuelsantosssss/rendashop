...
import 'atualizar_categoria_model.dart';
export 'atualizar_categoria_model.dart';

class AtualizarCategoriaWidget extends StatefulWidget {
  const AtualizarCategoriaWidget({super.key});

  static String routeName = 'Atualizar_categoria';
  static String routePath = '/atualizarCategoria';

  @override
  State<AtualizarCategoriaWidget> createState() =>
      _AtualizarCategoriaWidgetState();
}

class _AtualizarCategoriaWidgetState extends State<AtualizarCategoriaWidget> {
  late AtualizarCategoriaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AtualizarCategoriaModel());
