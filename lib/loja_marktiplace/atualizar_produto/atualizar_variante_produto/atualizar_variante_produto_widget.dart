...
class AtualizarVarianteProdutoWidget extends StatefulWidget {
  const AtualizarVarianteProdutoWidget({
    super.key,
  ...
  static String routeName = 'atualizarVarianteProduto';
  static String routePath = '/atualizarVarianteProduto';

  @override
  State<AtualizarVarianteProdutoWidget> createState() =>
      _AtualizarVarianteProdutoWidgetState();
}

class _AtualizarVarianteProdutoWidgetState
    extends State<AtualizarVarianteProdutoWidget> {
  late AtualizarVarianteProdutoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AtualizarVarianteProdutoModel());
                ...
                Padding(
                  ...
                  child: StreamBuilder<List<VarianteRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<VarianteRecord> listViewVarianteRecordList =
                          snapshot.data!;
                      ...
                      return ListView.builder(
                        ...
                        itemCount: listViewVarianteRecordList.length,
                        itemBuilder: (context, listViewIndex) {
                          final listViewVarianteRecord =
                              listViewVarianteRecordList[listViewIndex];
                          return InkWell(
                                ...
                                builder: (context) {
                                  return GestureDetector(
                                    ...
                                    child: Padding(
                                      ...
                                      child: EditarVarianteWidget(
                                        varianteRef:
                                            listViewVarianteRecord.reference,
                                        produtoRef:
                                            listViewVarianteRecord.produtoRef!,
                                      ),
                                    ),
                                  );
                                },
