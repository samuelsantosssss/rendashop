...
import 'venda_lojista_model.dart';
export 'venda_lojista_model.dart';

class VendaLojistaWidget extends StatefulWidget {
  const VendaLojistaWidget({super.key});

  static String routeName = 'venda-lojista';
  static String routePath = '/vendaLojista';

  @override
  State<VendaLojistaWidget> createState() => _VendaLojistaWidgetState();
}

class _VendaLojistaWidgetState extends State<VendaLojistaWidget> {
  late VendaLojistaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VendaLojistaModel());
            ...
            SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(10.0, 27.0, 10.0, 20.0),
                    child: wrapWithModel(
                      model: _model.saldoModel,
                                            ...
                                            Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      20.0, 0.0, 10.0, 0.0),
                                              child: Text(
                                                'R\$ ${functions.valorDoubleEmString(listViewPedidosTotalRecord.comissaoLojista)}',
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
                                                    .override(
