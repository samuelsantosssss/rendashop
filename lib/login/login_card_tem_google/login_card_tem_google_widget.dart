...
class LoginCardTemGoogleWidget extends StatefulWidget {
  const LoginCardTemGoogleWidget({
    super.key,
  ...
  static String routeName = 'loginCardTemGoogle';
  static String routePath = '/loginCardTemGoogle';

  @override
  State<LoginCardTemGoogleWidget> createState() =>
      _LoginCardTemGoogleWidgetState();
}

class _LoginCardTemGoogleWidgetState extends State<LoginCardTemGoogleWidget>
    with TickerProviderStateMixin {
  late LoginCardTemGoogleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LoginCardTemGoogleModel());
