...
import 'login_afiliado_card_tem_google_model.dart';
export 'login_afiliado_card_tem_google_model.dart';

class LoginAfiliadoCardTemGoogleWidget extends StatefulWidget {
  const LoginAfiliadoCardTemGoogleWidget({
    super.key,
  ...
  static String routeName = 'loginAfiliadoCardTemGoogle';
  static String routePath = '/loginAfiliadoCardTemGoogle';

  @override
  State<LoginAfiliadoCardTemGoogleWidget> createState() =>
      _LoginAfiliadoCardTemGoogleWidgetState();
}

class _LoginAfiliadoCardTemGoogleWidgetState
    extends State<LoginAfiliadoCardTemGoogleWidget>
    with TickerProviderStateMixin {
  late LoginAfiliadoCardTemGoogleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LoginAfiliadoCardTemGoogleModel());
                        ...
                        return Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                functions
                                    .confirmarEmail(columnUserRecord.email),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      font: GoogleFonts.inter(
