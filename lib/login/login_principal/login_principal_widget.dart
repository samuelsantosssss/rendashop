...
import 'login_principal_model.dart';
export 'login_principal_model.dart';

class LoginPrincipalWidget extends StatefulWidget {
  const LoginPrincipalWidget({super.key});

  static String routeName = 'loginPrincipal';
  static String routePath = '/loginPrincipal';

  @override
  State<LoginPrincipalWidget> createState() => _LoginPrincipalWidgetState();
}

class _LoginPrincipalWidgetState extends State<LoginPrincipalWidget>
    with TickerProviderStateMixin {
  late LoginPrincipalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LoginPrincipalModel());
