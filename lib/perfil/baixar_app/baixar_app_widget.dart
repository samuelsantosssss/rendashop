...
class BaixarAppWidget extends StatefulWidget {
  const BaixarAppWidget({super.key});

  @override
  State<BaixarAppWidget> createState() => _BaixarAppWidgetState();
}

class _BaixarAppWidgetState extends State<BaixarAppWidget>
    with TickerProviderStateMixin {
  late BaixarAppModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BaixarAppModel());
                ...
                children: [
                  ...
                  Flexible(
                    child: Align(
                      ...
                      child: Padding(
                        padding:
                            EdgeInsetsDirectional.fromSTEB(0.0, 2.0, 4.0, 0.0),
                        child: InkWell(
