...
import 'pesquisa_galeria_model.dart';
export 'pesquisa_galeria_model.dart';

class PesquisaGaleriaWidget extends StatefulWidget {
  const PesquisaGaleriaWidget({super.key});

  static String routeName = 'pesquisaGaleria';
  static String routePath = '/pesquisaGaleria';

  @override
  State<PesquisaGaleriaWidget> createState() => _PesquisaGaleriaWidgetState();
}

class _PesquisaGaleriaWidgetState extends State<PesquisaGaleriaWidget> {
  late PesquisaGaleriaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PesquisaGaleriaModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ProdutoRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ProdutoRecord> pesquisaGaleriaProdutoRecordList = snapshot.data!;
                                          ...
                                          context.pushNamed(
                                            ...
                                            queryParameters: {
                                              'documentList': serializeParam(
                                                pesquisaGaleriaProdutoRecordList,
                                                ParamType.Document,
                                                isList: true,
                                              ),
                                            }.withoutNulls,
                            ...
                            final produtoRef = functions
                                .buscarSugestoesPalavrasChaveDoc2(
                                    FFAppState()
                                        .palavraChavePesquisa
                                        .firstOrNull,
                                    pesquisaGaleriaProdutoRecordList.toList(),
                                    FFAppState().filtroNacional,
                                    FFAppState().filtroEntregaRapida,
                                    FFAppState().filtroLojaOficial,
                                    FFAppState().filtroInternacional,
                                                                    ...
                                                                    Text(
                                                                      containerProdutoRecord.titulo1 !=
                                                                          ...
                                                                          ? functions.valorRealString(containerProdutoRecord
                                                                              .menorPrecoRevenda)
                                                                          : functions
                                                                              .valorRealString(containerProdutoRecord.preco),
                                                                      style: FlutterFlowTheme.of(
                                                                              context)
                                                                          .bodyMedium
                                                                          .override(
                                                                    ...
                                                                    Text(
                                                                      containerProdutoRecord.titulo1 !=
                                                                          ...
                                                                          ? functions.valorCentavosEmString(containerProdutoRecord
                                                                              .menorPrecoRevenda)
                                                                          : functions
                                                                              .valorCentavosEmString(containerProdutoRecord.preco),
                                                                      style: FlutterFlowTheme.of(
                                                                              context)
                                                                          .bodyMedium
                                                                          .override(
